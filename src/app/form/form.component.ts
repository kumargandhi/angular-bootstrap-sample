...
export class FormComponent implements OnInit {
    ...
    setDefault() {
        ...
        question.setValue('Which of the following numbers is farthest from the number 1 on the number line?');
        ...
        (options as FormArray).controls[selectedOption].get('selected')?.setValue('selected' + selectedOption);
    }
